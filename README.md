...
#### src/html
- popup.html: miniture html page to display when the extension icon is displayed.
...
2. the bottom half is the payload. the 'Choose File' button can be used to open a file created by the server. the page will decrypt and load the data into a small table.
